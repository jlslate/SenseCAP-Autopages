...
/**
 * SenseCAP Auto-Pages Driver
 *
 * Four fixed pages on an openHASP (SenseCAP Indicator D1) display:
 *   Page 1 -- Smoke detectors
 *   Page 2 -- Motion sensors
 *   Page 3 -- Water sensors
 *   Page 4 -- Contact sensors
 *
 * Each page grid is sized automatically by the app based on sensor count.
 * Nav buttons and page indicator are baked into each page layout -- no page 0 overlay.
 * Each page is rendered completely (tiles + colors + icons + labels) before moving to next.
 *
